...
import incognita from "./assets/images/desco.png";
          ...
          {loader ? (
            ...
            <>
              <div className="justify-center  flex-1 lg:flex md:flex  gap-6">
                ...
                `}
                >
                  <h3>To buy you must approve the contract
                  </h3>
                  <img src={incognita} alt="" width={250} height={200} srcset="" />
